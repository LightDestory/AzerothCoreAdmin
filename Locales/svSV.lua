...
--[[General]]
  --[[Tooltips]]
    ["ma_IconHint"] = "|cffeda55fKlicka|r för att öppna TrinityAdmin. |cffeda55fShift-klicka|r för att ladda om ditt interface.",
    ["tt_Default"] = "Dra musen över ett element för att visa tooltipen!",
    ["tt_LanguageButton"] = "Ändra språk och ladda om TrinityAdmin.",
  --[[Control Labels]]
...
--[[GM tab]]
  --[[Name]]
     ["tabmenu_Main"] = "GM",
 --[[Tooltips]]
    ["tt_MainButton"] = "TrinityAdmins Huvudsida.",
...
--[[Log Tab]]
    ["tabmenu_Log"] = "Log",
    ["tt_LogButton"] = "Visa loggen för alla händelser gjorda med TrinityAdmin.",
  --[[Tooltips]]
  --[[Control Labels]]
  --[[Other]]
