...
--[[GM Tab]]
  ...
  MangAdmin:PrepareScript(ma_bagbutton                       , Locale["tt_BagButton"]                  , function() ShowBag("GM") end)
  ...
  MangAdmin:PrepareScript(ma_accountlockiponbutton           , Locale["tt_accountlockiponbutton"]      , function() ToggleAccountlockIP("on") end)
  MangAdmin:PrepareScript(ma_accountlockipoffbutton          , Locale["tt_accountlockipoffbutton"]     , function() ToggleAccountlockIP("off") end)
  ...
  MangAdmin:PrepareScript(ma_gmclearbutton                   , Locale["tt_clearParameterBox"]              , function() clearParametersBox("GM") end)
  ...
  MangAdmin:PrepareScript(ma_nocasttimeonbutton              , Locale["tt_nocasttimeonbutton"]         , function() ToggleNoCastTime("on") end)
  MangAdmin:PrepareScript(ma_nocasttimeoffbutton             , Locale["tt_nocasttimeoffbutton"]        , function() ToggleNoCastTime("off") end)
  MangAdmin:PrepareScript(ma_nocooldownonbutton              , Locale["tt_nocooldownonbutton"]         , function() ToggleNoCooldown("on") end)
  MangAdmin:PrepareScript(ma_nocooldownoffbutton             , Locale["tt_nocooldownoffbutton"]        , function() ToggleNoCooldown("off") end)
