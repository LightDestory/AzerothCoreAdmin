...
- [x] SERVER
- [x] LOG
- [x] PvP-No Data      (Pending Removal)
- [x] EVENT-No Data    (Pending Removal)
- [x] RPG-No Data      (Pending Remvval)
- [x] VENDOR-No Data   (Pending Removal)
- [x] AHBOT-No Data    (Pending Removal)
